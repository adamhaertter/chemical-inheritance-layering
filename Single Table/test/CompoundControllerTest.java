...
public class CompoundControllerTest
{
    ...
    {
        SingleCompoundController.createCompound ("Water");
    ...
    public void exceptionOnMissingCompound()
    {
        assertThrows(CompoundNotFoundException.class, () ->
                new SingleCompoundMapper("NOTHING"));
    }
    ...
    {
        // put the object I'm getting into the database
        SingleCompoundMapper.createCompound("Sulfuric Acid");
    ...
    public void canDelete()
    {
        ...
        SingleCompoundMapper.createCompound("HCl");
    ...
    {
        SingleCompoundMapper.createCompound("Water");
        new SingleElementMapper("Hydrogen",1, 2);
    ...
    {
        SingleCompoundMapper.createCompound(WATER);
        new SingleElementMapper("Hydrogen",1, HYDROGEN_ATOMIC_MASS);
        new SingleElementMapper("Oxygen",8, OXYGEN_ATOMIC_MASS);
