...
import mappers.SingleCompoundMapper;
import mappers.SingleElementMapper;
...
public class ElementControllerTest
{
    ...
    public void canGetExistingElement()
    {
        ...
        new SingleElementMapper("Oxygen", 8, 15.999);
    ...
    public void exceptionOnMissingElement()
    {
        assertThrows(ElementNotFoundException.class, () ->
                new SingleElementMapper("NOTHING"));
    }
    ...
    public void canUpdateAtomicNumber() throws ElementNotFoundException
    {
        ...
        checkElementDetails(new SingleElementMapper("Oxygen").getMyElement(), "Oxygen", 8,
                15.999);
    }
    ...
    {
        // put the object I'm getting into the database
        new SingleElementMapper("Oxygen", 8, 15.99);
        ...
        // Make sure it did not go all the way to the database
        checkElementDetails(new SingleElementMapper("Oxygen").getMyElement(), "Oxygen",
                    8, 15.999);
    }
    ...
    public void canUpdateAndPersistName() throws ElementNotFoundException
    {
        ...
        checkElementDetails((new SingleElementMapper("Yucky Oxygen")).getMyElement(), "Yucky Oxygen",
                8, 15.999);
    }
    @Test
    public void canPersistEverythingExceptName() throws ElementNotFoundException
    {
        ...
        checkElementDetails((new SingleElementMapper("Oxygen")).getMyElement(), "Oxygen", 42,
                42.25);
    }
    @Test
    ...
    {
        new SingleElementMapper("Hydrogen", 1, 2.1);
        new SingleElementMapper("Oxygen", 8, 15.99);
        new SingleElementMapper ("Sodium", 11, 22.990);

        SingleCompoundMapper.createCompound("Water");
        ...
        SingleCompoundMapper.createCompound("Sodium Hydroxide");
    ...
    private static void checkPeriodForAtomicNumber(int atomicNumber,
                                                   int expectedPeriod)
    {
        SingleElementMapper mapper = new SingleElementMapper("Name" + atomicNumber,
                atomicNumber, 42.2);
    ...
    private void loadDB(ElementForTest @NotNull [] elements)
    {
        ...
        {
            new SingleElementMapper(e.name, e.atomicNumber, e.atomicMass);
        }
    }
